...
public class GestoreApplicazioni extends UnicastRemoteObject {
	private static GestoreApplicazioni instance=null;
	private int raggio;
	
	private static final long serialVersionUID = 7787401541047824619L;  //se non funziona cambiare questa
